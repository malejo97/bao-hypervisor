...
#define CSR_VSSECCFG      0x281
#define CSR_VSSECCFGH     0x291
...
#define CSR_HSPMPSWITCH0  0x682
#define CSR_HSPMPSWITCH1  0x683
...
CSRS_GEN_ACCESSORS_NAMED(vsiselect, CSR_SISELECT);
CSRS_GEN_ACCESSORS_NAMED(vsireg, CSR_VSIREG);
CSRS_GEN_ACCESSORS_NAMED(vsireg2, CSR_VSIREG2);
CSRS_GEN_ACCESSORS_NAMED(vsireg3, CSR_VSIREG3);
CSRS_GEN_ACCESSORS_NAMED(vsireg4, CSR_VSIREG4);
CSRS_GEN_ACCESSORS_NAMED(vsireg5, CSR_VSIREG5);
CSRS_GEN_ACCESSORS_NAMED(vsireg6, CSR_VSIREG6);
...
CSRS_GEN_ACCESSORS_NAMED(vsseccfg, CSR_VSSECCFG);
...
CSRS_GEN_ACCESSORS_NAMED(hspmpswitch, CSR_HSPMPSWITCH0);
CSRS_GEN_ACCESSORS_NAMED(vspmpswitch, CSR_VSPMPSWITCH0);
#else
...
CSRS_GEN_ACCESSORS_NAMED(vsseccfgl, CSR_VSSECCFG);
CSRS_GEN_ACCESSORS_NAMED(vsseccfgh, CSR_VSSECCFGH);
CSRS_GEN_ACCESSORS_MERGED(vsseccfg, vsseccfgl, vsseccfgh)
...
CSRS_GEN_ACCESSORS_NAMED(hspmpswitch0, CSR_HSPMPSWITCH0);
CSRS_GEN_ACCESSORS_NAMED(hspmpswitch1, CSR_HSPMPSWITCH1);
CSRS_GEN_ACCESSORS_MERGED(hspmpswitch, hspmpswitch0, hspmpswitch1);

CSRS_GEN_ACCESSORS_NAMED(vspmpswitch0, CSR_VSPMPSWITCH0);
CSRS_GEN_ACCESSORS_NAMED(vspmpswitch1, CSR_VSPMPSWITCH1);
CSRS_GEN_ACCESSORS_MERGED(vspmpswitch, vspmpswitch0, vspmpswitch1);
#endif
